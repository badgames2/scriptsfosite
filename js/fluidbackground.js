...
function splat(x, y, dx, dy, color) {
    ...
    const desaturatedColor = [luminance, luminance, luminance];

    // Set the color with saturation adjustment
    const finalColor = [
        mix(desaturatedColor[0], adjustedColor[0], saturationFactor),
        mix(desaturatedColor[1], adjustedColor[1], saturationFactor),
        mix(desaturatedColor[2], adjustedColor[2], saturationFactor)
    ];
